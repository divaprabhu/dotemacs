...
- *create .dir-locals.el file in project root with these contents*
  ...
  . ((eglot-workspace-configuration
      . (:pylsp (:plugins (:jedi (:environment "/home/dvp/.cache/venvs/langchain")))))
     (indent-tabs-mode . -1)
     (python-shell-interpreter
      . "/home/dvp/.cache/venvs/langchain/bin/python")
     (python-shell-virtualenv-root
      . "/home/dvp/.cache/venvs/langchain/bin/python")
     (eshell-directory-local-path . ("/home/dvp/.cache/venvs/langchain/bin"))
     ;; 1. Set the PATH environment variable for sub-processes (like M-x shell)
     ;; 'nil' means these settings apply to all modes within this directory tree.
     (eval . (setenv "PATH"
                     (concat  "/home/dvp/.cache/venvs/langchain/bin" 
                             ":"
                             (getenv "PATH"))))

     ;; 2. Update Emacs's internal list of executable paths (used by packages like flycheck)
     (eval . (setq-local exec-path
			 (cons  "/home/dvp/.cache/venvs/langchain/bin"
                               exec-path)))
     )))
  #+end_quote
