...
#+end_src
- Automatically shrink or expand minibuffer based on number of lines of text
  #+begin_src emacs-lisp
...
- create .dir-locals.el file in project root with these contents
  ...
  . ((eglot-workspace-configuration
      . (:pylsp (:plugins (:jedi (:environment "/home/dvp/.cache/venvs/pyspark")))))
     (indent-tabs-mode . nil)
     (python-shell-interpreter
  . "/home/dvp/.cache/venvs/pyspark/bin/python"))))
  #+end_src
...
- Refer [[*Xref][Xref]]
  #+begin_src emacs-lisp
    (use-package eglot
	  ...
	  (setq exec-path (append exec-path '("~/.cache/lsp/pylsp/Scripts")))
	(setq exec-path (append exec-path '("~/.cache/lsp/pylsp/bin")))))
    ;;   :config
    ;;
