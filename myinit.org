...
* Indentation
  ...
  | *M-i*     | *kJ*      | tab-to-tab-stop (indent at point up to next tabstop)                                |
  | *M-^*     |           | delete-indentation (merge current and previous line)                                |
...
:END:
   ...
   | *M-,*               | xref-pop-marker-stack (go back to where you invoked M-.)            |
...
* Dired
  ...
  | *q*                             | quit-window                                                               |
  | *j*                             | dired-goto-file (prompt file-name and move point to it)                   |
